...
const subscriptionCardSchema = z
  .object({
    holder_name: z
      .string()
      .trim()
      .min(2, "Informe o nome impresso no cartao")
      .max(100)
      .optional(),
    holder_cpf_cnpj: z
      .string()
    ...
    number: z
      ...
      .refine(
        ...
        "Informe um cartao entre 13 e 19 digitos",
      )
      .refine(passesLuhnCheck, "Informe um numero de cartao valido"),
    expiry_month: z
      .string()
      .trim()
      .regex(/^(0[1-9]|1[0-2])$/, "Informe o mes no formato MM"),
    expiry_year: z
      .string()
      .trim()
      .regex(/^\d{4}$/, "Informe o ano com quatro digitos"),
    ccv: z
      .string()
      .trim()
      .regex(/^\d{3,4}$/, "Informe um codigo de seguranca valido"),
  })
  .strict()
...
export const updateOrganizationInputSchema = z
  .object({
    ...
    default_commission_percentage: z
      .number()
      .finite()
      .min(0)
      .max(100)
      .nullable()
      .optional(),
    property_edit_policy: z
      .enum(["everyone", "responsible_or_admin"])
      .nullable()
      .optional(),
    property_owner_contact_visibility: z
      .enum(["visible", "hidden"])
      .nullable()
      .optional(),
  })
...
export const updatePropertySettingsInputSchema = z
  .object({
  ...
  .refine(
    (input) =>
      input.property_edit_policy !== undefined
      || input.property_owner_contact_visibility !== undefined,
    "Informe ao menos uma alteracao",
  );

export type UpdatePropertySettingsInput = z.infer<
  typeof updatePropertySettingsInputSchema
>;

export const propertySettingsUpdateResponseSchema = z
  .object({
    ok: z.literal(true),
...
export const changePasswordInputSchema = z
  ...
  .strict();
export const setupGuideProgressInputSchema = z
  .object({
...
export const pushTokenInputSchema = z
  .object({
...
export const createApiKeyInputSchema = z
  ...
  .strict();
export const subscriptionBillingInputSchema = z
  .object({
    razao_social: nullableText(200),
    cnpj: nullableText(30),
    cep: nullableText(20),
...
export const subscriptionChargeInputSchema = z
  .object({
  ...
  .superRefine((input, context) => {
    ...
    if (input.card && input.billing_type !== "CREDIT_CARD") {
      context.addIssue({
        ...
        path: ["card"],
        message:
          "Dados de cartao sao aceitos somente para pagamento com cartao de credito",
      });
    }
    ...
    if (input.billing_type === "CREDIT_CARD" && !input.card) {
      context.addIssue({
        ...
        path: ["card"],
        message:
          "Informe os dados do cartao para concluir o pagamento dentro da Vimob",
      });
    }
    ...
    if (input.billing_type === "CREDIT_CARD" && !input.idempotency_key) {
      context.addIssue({
        ...
        message:
          "Identificador idempotente do pagamento com cartao e obrigatorio",
      });
    }
...
export const selectSubscriptionPlanInputSchema = z
  .object({ plan_id: uuidSchema })
  .strict();
export const replaceRolePermissionsInputSchema = z
  .object({
    permissions: z.array(z.string().trim().min(1).max(180)).max(500),
  })
  .strict();
export const replaceUserPermissionsInputSchema = z
  .object({
    permissions: z.record(z.boolean()),
  })
  .strict();
export const assignUserRoleInputSchema = z
  .object({
    userId: uuidSchema,
    roleId: uuidSchema.nullable(),
  })
  .strict();
export const settingsRoleInputSchema = z
  .record(z.unknown())
  .refine(
    (input) => Object.keys(input).length > 0,
    "Informe ao menos uma alteracao",
  );
export const deactivatePushTokenInputSchema = z
  .object({
...
export const apiAssetUploadSchema = z
  .object({
    url: z.string().min(1),
    path: z.string().min(1),
  ...
  .passthrough();
export const apiOrganizationApiKeySchema = z
  .object({
    id: uuidSchema,
  ...
  .passthrough();
export const apiOrganizationModuleSchema = z
  .object({
    id: uuidSchema,
    organization_id: uuidSchema,
  ...
  .passthrough();
export const apiSetupGuideProgressSchema = z
  .object({
    completed_steps: z.record(z.boolean()),
    skipped: z.boolean(),
  })
  .passthrough();
export const apiPublicPushConfigSchema = z
  .object({
    enabled: z.boolean(),
  ...
  .strict();
export const apiPaymentHistoryItemSchema = z
  .object({
    id: uuidSchema,
    ...
    checkout_url: z
      .string()
      .regex(/^\/checkout\/[a-f0-9]{64}$/)
      .nullable()
      .default(null),
    receipt_path: z
      .string()
      .regex(
        /^\/comprovantes\/[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/,
      )
      .nullable()
      .default(null),
    sync_state: z
      .enum(["cached", "current", "provider_unavailable"])
      .default("cached"),
    created_at: timestampSchema,
    updated_at: timestampSchema,
  })
  .strict();
export const apiPaymentHistoryItemResponseSchema = apiEnvelopeSchema(
  apiPaymentHistoryItemSchema,
);
export const apiSubscriptionOverviewSchema = z
  .object({
  ...
  .passthrough();
export const apiUserPermissionItemSchema = z
  .object({
  ...
  .strict();
export const apiUserPermissionProfileSchema = z
  .object({
    userId: uuidSchema,
    name: z.string().min(1),
  ...
  .strict();
export const apiUserPermissionProfileResponseSchema = apiEnvelopeSchema(
  apiUserPermissionProfileSchema,
);

export const apiAssetUploadResponseSchema =
  apiEnvelopeSchema(apiAssetUploadSchema);
export const apiOrganizationApiKeyListResponseSchema = apiEnvelopeSchema(
  z.array(apiOrganizationApiKeySchema),
);
export const apiOrganizationModuleListResponseSchema = apiEnvelopeSchema(
  z.array(apiOrganizationModuleSchema),
);
export const apiSetupGuideProgressResponseSchema = apiEnvelopeSchema(
  apiSetupGuideProgressSchema,
);
export const apiPublicPushConfigResponseSchema = apiEnvelopeSchema(
  apiPublicPushConfigSchema,
);
export const apiCreateApiKeyResponseSchema = apiEnvelopeSchema(
  z
    .object({
...
export const apiSubscriptionOverviewResponseSchema = apiEnvelopeSchema(
  apiSubscriptionOverviewSchema,
);
export const apiBooleanResponseSchema = apiEnvelopeSchema(z.boolean());
export const apiChangePasswordResponseSchema = z
  .object({
    allowed: z.boolean(),
    message: z.string(),
