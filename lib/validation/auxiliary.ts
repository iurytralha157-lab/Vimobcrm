...
export const auditLogListInputSchema = z
  ...
  .strict();
export const auditLogCreateInputSchema = z
  .object({
...
const auditLogSchema = z
  ...
  .passthrough();
export const apiAuditLogListResponseSchema = z
  .object({
...
const conversationLeadDetailSchema = z
  .object({
    id: uuidSchema,
    name: z.string(),
    ...
    tags: z.array(
      z
        .object({
          tag: z
            .object({ id: uuidSchema, name: z.string(), color: z.string() })
            .passthrough(),
        })
        .passthrough(),
    ),
  ...
  .passthrough();
export const apiConversationLeadDetailResponseSchema = apiEnvelopeSchema(
  conversationLeadDetailSchema,
);

export const leadAttachmentCreateInputSchema = z
  .object({
    lead_id: uuidSchema,
...
const leadAttachmentSchema = z
  ...
  .passthrough();
export const apiLeadAttachmentResponseSchema =
  apiEnvelopeSchema(leadAttachmentSchema);
export const apiLeadAttachmentListResponseSchema = apiEnvelopeSchema(
  z.array(leadAttachmentSchema),
);

const leadEnrichmentSchema = z
  .object({
    lead_id: uuidSchema,
    tags: z.array(
      z
        .object({ id: uuidSchema, name: nullableString, color: nullableString })
        .passthrough(),
    ),
    tasks_count: z
      .object({
  ...
  .passthrough();
export const apiLeadEnrichmentListResponseSchema = apiEnvelopeSchema(
  z.array(leadEnrichmentSchema),
);
...
const leadMetaSchema = z
  ...
  .passthrough();
export const apiLeadMetaResponseSchema = apiEnvelopeSchema(
  leadMetaSchema.nullable(),
);

export const leadTaskTypeSchema = z.enum(["call", "message", "email", "note"]);
export const leadTaskCreateInputSchema = z
  .object({
    lead_id: uuidSchema,
  ...
  .strict();
export const leadTaskPatchInputSchema = z
  .object({
...
export const cadenceTaskCompletionInputSchema = z
  .object({
    leadId: uuidSchema,
    taskId: uuidSchema.optional(),
    templateTaskId: uuidSchema.optional(),
    dayOffset: z.number().int().min(0).max(3_650).optional(),
    type: leadTaskTypeSchema.optional(),
  ...
  .strict()
  .refine((value) => Boolean(value.taskId || value.templateTaskId), {
    path: ["taskId"],
    message: "Informe a tarefa materializada ou a tarefa do modelo",
  });
const leadTaskSchema = z
  .object({ id: uuidSchema, lead_id: uuidSchema })
  .passthrough();
export const apiLeadTaskResponseSchema = apiEnvelopeSchema(leadTaskSchema);
export const apiLeadTaskListResponseSchema = apiEnvelopeSchema(
  z.array(leadTaskSchema),
);
export const apiLeadVisibilityResponseSchema = apiEnvelopeSchema(
  z
    .object({
...
export const messageTemplateCreateInputSchema = z
  ...
  .strict();
export const messageTemplateUpdateInputSchema = messageTemplateCreateInputSchema
  .partial()
  .omit({ variables: true })
  .refine(
    (value) => Object.keys(value).length > 0,
...
const messageTemplateSchema = z
  ...
  .passthrough();
export const apiMessageTemplateResponseSchema = apiEnvelopeSchema(
  messageTemplateSchema,
);
export const apiMessageTemplateListResponseSchema = apiEnvelopeSchema(
  z.array(messageTemplateSchema),
);

export const paymentCheckoutQuerySchema = z
  .object({
  ...
  .strict()
  .refine(
    (value) => Boolean(value.token || value.organization_id),
    "Informe token ou organização",
  );
export const checkoutBillingProfileSessionSchema = z
  .object({
    organization_id: uuidSchema,
    name: z.string().trim().min(1).max(160),
    email: z.string().trim().email().max(180),
    cpf_cnpj: z.string().trim().max(32),
    phone: z.string().trim().max(32),
    created_at: z.number().int().nonnegative(),
  })
  .strict();
export const checkoutBillingDraftSessionSchema = z
  .object({
    checkout_token: z
      .string()
      .trim()
      .regex(/^(?:[a-f0-9]{32}|[a-f0-9]{48}|[a-f0-9]{64})$/i),
    organization_id: uuidSchema,
    name: z.string().max(200),
    email: z.string().max(320),
    cpf_cnpj: z.string().max(32),
    phone: z.string().max(32),
    country: z.literal("BR"),
    postal_code: z.string().max(20),
    address: z.string().max(200),
    address_number: z.string().max(40),
...
export const paymentStatusQuerySchema = z
  .object({
    checkout_token: z.string().trim().min(8).max(2_000).optional(),
    organization_id: uuidSchema.optional(),
    intent_id: safePathSegmentSchema.nullish(),
    payment_id: safePathSegmentSchema.nullish(),
    subscription_id: safePathSegmentSchema.nullish(),
    card_update_job_id: uuidSchema.nullish(),
  })
  .strict()
  .refine(
    (value) => Boolean(value.checkout_token) !== Boolean(value.organization_id),
    "Informe somente o checkout ou a organização",
  );
export const paymentMutationInputSchema = z
  .object({
    checkout_token: z.string().trim().min(8).max(2_000).optional(),
    organization_id: uuidSchema.optional(),
    intent_id: safePathSegmentSchema.nullish(),
...
export const propertyCatalogCreateInputSchema = z
  .object({
    name: z.string().trim().min(1).max(180),
    icon: z.string().trim().max(255).nullish(),
  })
  .strict();
export const propertyCatalogSeedInputSchema = z
  .object({
    names: z.array(z.string().trim().min(1).max(180)).min(1).max(500),
  })
  .strict();
const propertyCatalogItemSchema = z
  .object({
    id: uuidSchema,
    organization_id: uuidSchema,
    name: z.string(),
  ...
  .passthrough();
export const apiPropertyCatalogResponseSchema = apiEnvelopeSchema(
  propertyCatalogItemSchema,
);
export const apiPropertyCatalogListResponseSchema = apiEnvelopeSchema(
  z.array(propertyCatalogItemSchema),
);
export const apiPropertyImageResponseSchema = apiEnvelopeSchema(
  z
    .object({
      url: z.string().url(),
      path: z.string().min(1),
...
export const propertyCityInputSchema = z
  .object({
...
export const propertyCondominiumInputSchema = z
  .object({
    ...
    concierge_type: z.string().trim().max(80).optional(),
...
export const apiPropertyCityResponseSchema =
  apiEnvelopeSchema(propertyCitySchema);
export const apiPropertyCityListResponseSchema = apiEnvelopeSchema(
  z.array(propertyCitySchema),
);
export const apiPropertyNeighborhoodResponseSchema = apiEnvelopeSchema(
  propertyNeighborhoodSchema,
);
export const apiPropertyNeighborhoodListResponseSchema = apiEnvelopeSchema(
  z.array(propertyNeighborhoodSchema),
);
export const apiPropertyCondominiumResponseSchema = apiEnvelopeSchema(
  propertyCondominiumSchema,
);
export const apiPropertyCondominiumListResponseSchema = apiEnvelopeSchema(
...
const propertyCaptorSchema = z
  ...
  .passthrough();
const propertySiteInfoSchema = z
  .object({
...
const propertySummarySchema = z
  ...
  .passthrough();
export const apiPropertyCaptorResponseSchema = apiEnvelopeSchema(
  propertyCaptorSchema.nullable(),
);
export const apiPropertySiteInfoResponseSchema = apiEnvelopeSchema(
  propertySiteInfoSchema.nullable(),
);
export const apiPropertySummaryListResponseSchema = apiEnvelopeSchema(
  z.array(propertySummarySchema),
);

export const publicDomainSchema = z
  .string()
  .trim()
  .min(1)
  .max(253)
  .transform((value) => value.toLowerCase());
export const publicSiteQuerySchema = z.record(
  z.union([
    z.string(),
    z.number().finite(),
    z.boolean(),
...
export const apiPublicSiteResolveResponseSchema = z
  .object({
    found: z.boolean(),
    site_config: dynamicRecordSchema.optional(),
  })
  .passthrough();
export const apiPublicDataResponseSchema = z.unknown();
export const publicSiteConfigSchema = z
  .object({
    id: uuidSchema,
    organization_id: uuidSchema,
    is_active: z.boolean(),
...
export const publicPropertySchema = z
  ...
  .passthrough();
export const publicHomeDataSchema = z
  .object({
  ...
  .passthrough();
export const publicPropertiesDataSchema = z
  .object({
  ...
  .passthrough();
export const publicPropertyDataSchema = z
  .object({
    property: publicPropertySchema.nullable(),
  })
  .passthrough();
export const publicSiteResolveServerSchema = z
  .object({
    found: z.boolean().optional(),
    site_config: publicSiteConfigSchema.optional(),
  })
  .passthrough();
export const publicMenuItemListEnvelopeSchema = apiEnvelopeSchema(
  z.array(
    z
      .object({
        id: uuidSchema,
...
export const publicSearchFilterListEnvelopeSchema = apiEnvelopeSchema(
  z.array(
    z
      .object({
        filter_key: z.string(),
...
export const siteAssetInputSchema = z
  .object({
...
export const siteCustomDomainSchema = z
  .string()
  .trim()
  .toLowerCase()
...
const organizationSiteSchema = z
  .object({
    id: uuidSchema,
    organization_id: uuidSchema,
    is_active: z.boolean(),
    maintenance_mode: z.boolean(),
    maintenance_message: z.string().max(500).nullable(),
    subdomain: siteSlugSchema.nullable(),
    custom_domain: siteCustomDomainSchema.nullable(),
    domain_verified: z.boolean(),
    domain_verified_at: timestampSchema.nullable(),
  ...
  .passthrough();
export const organizationSiteMutationSchema = organizationSiteSchema
  .omit({
    id: true,
...
const siteMenuItemSchema = z
  .object({
    ...
    organization_id: uuidSchema,
    label: z.string(),
    link_type: z.enum(["page", "filter", "external"]),
    href: z.string(),
    position: nonNegativeIntegerSchema,
    open_in_new_tab: z.boolean(),
    is_active: z.boolean(),
  ...
  .passthrough();
export const siteMenuItemInputSchema = siteMenuItemSchema
  .omit({
    id: true,
    organization_id: true,
  })
  .partial({ open_in_new_tab: true, is_active: true })
  .strict();
export const siteMenuItemUpdateSchema = siteMenuItemSchema
  .partial()
  .extend({
    id: uuidSchema,
  })
  .strict();
const siteSearchFilterSchema = z
  .object({
    id: uuidSchema,
    organization_id: uuidSchema,
    filter_key: z.string(),
  ...
  .passthrough();
export const siteSearchFilterInputSchema = siteSearchFilterSchema
  .pick({
    filter_key: true,
    label: true,
    position: true,
  ...
  .strict();
export const siteSearchFilterUpdateSchema = siteSearchFilterSchema
  .partial()
  .extend({ id: uuidSchema })
  .strict();
export const siteReorderInputSchema = z
  .object({
    items: z
      .array(
        z
          .object({ id: uuidSchema, position: nonNegativeIntegerSchema })
          .strict(),
      )
      .min(1)
      .max(500),
  ...
  .strict();
export const apiOrganizationSiteResponseSchema = apiEnvelopeSchema(
  organizationSiteSchema,
);
export const apiOptionalOrganizationSiteResponseSchema = apiEnvelopeSchema(
  organizationSiteSchema.nullable(),
);
export const apiSiteMenuItemResponseSchema =
  apiEnvelopeSchema(siteMenuItemSchema);
export const apiSiteMenuItemListResponseSchema = apiEnvelopeSchema(
  z.array(siteMenuItemSchema),
);
export const apiSiteSearchFilterResponseSchema = apiEnvelopeSchema(
  siteSearchFilterSchema,
);
export const apiSiteSearchFilterListResponseSchema = apiEnvelopeSchema(
  z.array(siteSearchFilterSchema),
);
export const apiSiteAssetResponseSchema = apiEnvelopeSchema(
  z.object({ url: z.string().url() }).passthrough(),
);
export const apiDomainVerificationResponseSchema = apiEnvelopeSchema(
  z
    .object({
      ...
      reason: z
        .enum(["challenge_unavailable", "challenge_mismatch"])
        .optional(),
    })
    .strict(),
);
    ...
    lighthouseResult: z
      .object({
        ...
        categories: z
          .object({
            performance: z
              .object({ score: z.number().min(0).max(1).nullable() })
              .passthrough(),
          })
          .passthrough(),
        audits: z
...
export const stageAutomationInputSchema = z
  .object({
    stage_id: uuidSchema.optional(),
    automation_type: z.string().trim().max(120).optional(),
    trigger_days: z.number().int().min(0).max(3_650).nullish(),
    target_stage_id: optionalUUID,
    whatsapp_template: optionalNullableString,
    alert_message: optionalNullableString,
    target_user_id: optionalUUID,
    deal_status: z.enum(["open", "won", "lost"]).nullish(),
    action_config: dynamicRecordSchema.nullish(),
...
export const stageOperationalConfigInputSchema = z
  .object({
    id: uuidSchema.optional(),
    stage_id: uuidSchema,
    operation_context: z.string().max(180).optional(),
    responsible_sector: optionalNullableString,
    sla_hours: z.number().int().min(0).max(100_000).optional(),
    automatic_tasks: jsonValueSchema.optional(),
    automatic_notifications: jsonValueSchema.optional(),
    automatic_operational_requests: jsonValueSchema.optional(),
    checklist_template: jsonValueSchema.optional(),
    approval_flow: jsonValueSchema.optional(),
    dashboard_destination: optionalNullableString,
    visibility_rules: jsonValueSchema.optional(),
  })
  .strict();
export const pipelineSLAInputSchema = z
  .object({
    pipeline_id: uuidSchema,
    stage_id: optionalUUID,
    warning_hours: z.number().int().min(0).max(100_000).optional(),
    critical_hours: z.number().int().min(0).max(100_000).optional(),
    sla_start_field: z.string().trim().max(120).optional(),
  })
  .strict();
const stageAutomationSchema = z
  .object({
    id: uuidSchema,
    organization_id: uuidSchema,
  ...
  .passthrough();
const stageOperationalConfigSchema = z
  .object({
    organization_id: uuidSchema,
    stage_id: uuidSchema,
    operation_context: z.string(),
    sla_hours: nonNegativeIntegerSchema,
  })
  .passthrough();
const pipelineSLASchema = z
  .object({
    id: uuidSchema,
    organization_id: uuidSchema,
    pipeline_id: uuidSchema,
  ...
  .passthrough();
export const apiStageAutomationResponseSchema = apiEnvelopeSchema(
  stageAutomationSchema,
);
export const apiStageAutomationListResponseSchema = apiEnvelopeSchema(
  z.array(stageAutomationSchema),
);
export const apiStageOperationalResponseSchema = apiEnvelopeSchema(
  stageOperationalConfigSchema,
);
export const apiStageOperationalListResponseSchema = apiEnvelopeSchema(
  z.array(stageOperationalConfigSchema),
);
export const apiPipelineSLAResponseSchema =
  apiEnvelopeSchema(pipelineSLASchema);
export const apiPipelineSLAListResponseSchema = apiEnvelopeSchema(
  z.array(pipelineSLASchema),
);
...
export const reportErrorEventInputSchema = z
  .object({
    organizationId: uuidSchema.nullish(),
    ...
    errorCode: z.string().max(180).optional(),
    ...
    stackHash: z.string().max(255).optional(),
    fingerprint: z.string().max(500).optional(),
    url: z.string().max(4_000).optional(),
    userAgent: z.string().max(2_000).optional(),
    browserContext: dynamicRecordSchema.optional(),
    metadata: dynamicRecordSchema.optional(),
  })
  .strict();
export const errorEventFiltersSchema = z
  .object({
    limit: z.number().int().min(1).max(200).optional(),
    offset: z.number().int().min(0).max(100_000).optional(),
    search: z.string().trim().max(120).optional(),
    severity: z.union([errorSeveritySchema, z.literal("all")]).optional(),
    source: z.union([errorSourceSchema, z.literal("all")]).optional(),
    organizationId: uuidSchema.optional(),
...
const errorEventSchema = z
  .object({
    ...
    browserContext: dynamicRecordSchema,
    metadata: dynamicRecordSchema,
    createdAt: timestampSchema,
...
export const apiErrorEventListResponseSchema = z
  .object({
    data: z.array(errorEventSchema),
    total: nonNegativeIntegerSchema,
...
const userSummarySchema = z
  ...
  .passthrough();
export const apiUserSummaryListResponseSchema = apiEnvelopeSchema(
...
const webhookMutationSchema = z
  .object({
    ...
    target_pipeline_id: optionalUUID,
    target_team_id: optionalUUID,
    target_stage_id: optionalUUID,
...
const webhookSchema = z
  .object({
    ...
    api_token: z.string(),
    is_active: z.boolean(),
    leads_received: nonNegativeIntegerSchema,
    created_at: timestampSchema,
    updated_at: timestampSchema,
  })
  .passthrough();
export const apiWebhookResponseSchema = apiEnvelopeSchema(webhookSchema);
export const apiWebhookListResponseSchema = apiEnvelopeSchema(
  z.array(webhookSchema),
);

export const metaCampaignListSchema = z.array(
  z
    .object({
      id: z.string().min(1),
      name: z.string(),
      kind: z.enum(["lead_form", "whatsapp", "site"]),
      status: z.enum(["ACTIVE", "PAUSED", "ARCHIVED", "LEARNING"]),
      adSets: z.array(
        z
          .object({
            id: z.string().min(1),
...
export const searchFilterColumnsSchema = z
  .array(
    z
      .string()
      .trim()
