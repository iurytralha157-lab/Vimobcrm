...
export const metaMarketingSyncInputSchema = z
  .object({
...
export const metaMarketingSyncResponseSchema = z
  .object({
...
export type MetaMarketingSyncInput = z.infer<
  typeof metaMarketingSyncInputSchema
>;
export type MetaMarketingSyncResponse = z.infer<
  typeof metaMarketingSyncResponseSchema
>;

const marketingAdSchema = z
  .object({
    ...
    status: nullableTextSchema.optional().default(null),
    creative_id: nullableTextSchema.optional().default(null),
...
const marketingAdsetSchema = z
  .object({
    ...
    hook_rate: nullableMetricSchema.optional().default(null),
    status: nullableTextSchema.optional().default(null),
    budget: nullableMetricSchema.optional().default(null),
    budget_type: nullableTextSchema.optional().default(null),
    optimization_goal: nullableTextSchema.optional().default(null),
    currency: z
      .string()
      .trim()
      .min(1)
...
const marketingCampaignSchema = z
  .object({
    ...
    meta_reported_leads: nonNegativeIntegerSchema.optional(),
    meta_reported_conversations: nonNegativeIntegerSchema.optional(),
    reported_results: nonNegativeIntegerSchema.optional(),
    crm_attributed_leads: nonNegativeIntegerSchema.optional(),
    capture_gap: finiteIntegerSchema.optional(),
    capture_rate: nullableMetricSchema.optional(),
    contacted_count: nonNegativeIntegerSchema.optional().default(0),
    responded_count: nonNegativeIntegerSchema.optional().default(0),
    qualified_count: nonNegativeIntegerSchema.optional().default(0),
  ...
  .passthrough()
  .transform((campaign) => {
    const metaReportedLeads =
      campaign.meta_reported_leads ?? campaign.leads_reported;
    const metaReportedConversations =
      campaign.meta_reported_conversations ?? campaign.conversations_count;
    const reportedResults =
      campaign.reported_results ??
      metaReportedLeads + metaReportedConversations;
    const crmAttributedLeads =
      campaign.crm_attributed_leads ?? campaign.leads_count;
    return {
      ...campaign,
      meta_reported_leads: metaReportedLeads,
      meta_reported_conversations: metaReportedConversations,
      reported_results: reportedResults,
      crm_attributed_leads: crmAttributedLeads,
      capture_gap: campaign.capture_gap ?? reportedResults - crmAttributedLeads,
      capture_rate:
        campaign.capture_rate ??
        (reportedResults > 0
          ? (crmAttributedLeads * 100) / reportedResults
          : null),
    };
  });

const marketingTopCreativeSchema = z
  .object({
    ad_id: providerIdSchema,
    ad_name: z
      .string()
...
const marketingDailyPerformanceSchema = z
  .object({
    ...
    metaReportedLeads: nonNegativeIntegerSchema.optional(),
    metaReportedConversations: nonNegativeIntegerSchema.optional(),
    reportedResults: nonNegativeIntegerSchema.optional(),
    crmAttributedLeads: nonNegativeIntegerSchema.optional(),
    captureGap: finiteIntegerSchema.optional(),
    captureRate: nullableMetricSchema.optional(),
  ...
  .passthrough()
  .transform((day) => {
    const metaReportedLeads = day.metaReportedLeads ?? day.leadsReported;
    const metaReportedConversations =
      day.metaReportedConversations ?? day.conversations;
    const reportedResults =
      day.reportedResults ?? metaReportedLeads + metaReportedConversations;
    const crmAttributedLeads = day.crmAttributedLeads ?? day.leads;
    return {
      ...day,
      metaReportedLeads,
      metaReportedConversations,
      reportedResults,
      crmAttributedLeads,
      captureGap: day.captureGap ?? reportedResults - crmAttributedLeads,
      captureRate:
        day.captureRate ??
        (reportedResults > 0
          ? (crmAttributedLeads * 100) / reportedResults
...
const marketingMediaAssetSchema = z
  .object({
...
const currencyBreakdownSchema = z
  .array(
    z
      .object({
...
const marketingSummarySchema = z
  ...
  .transform((summary) => {
    const metaReportedLeads =
      summary.metaReportedLeads ?? summary.reportedLeads;
    const metaReportedConversations =
      summary.metaReportedConversations ?? summary.conversations_count;
    const reportedResults =
      summary.reportedResults ?? metaReportedLeads + metaReportedConversations;
    const crmAttributedLeads = summary.crmAttributedLeads ?? summary.totalLeads;
    return {
      ...summary,
      metaReportedLeads,
      metaReportedConversations,
      reportedResults,
      crmAttributedLeads,
      captureGap: summary.captureGap ?? reportedResults - crmAttributedLeads,
      captureRate:
        summary.captureRate ??
        (reportedResults > 0
          ? (crmAttributedLeads * 100) / reportedResults
...
const marketingConnectionSchema = z
  .object({
    ...
    marketingTokenAvailable: z.boolean().optional().default(false),
    instagramInsightsAvailable: z.boolean().optional().default(false),
    lastIntegrationSync: nullableTextSchema.optional().default(null),
  })
  .passthrough();

const marketingDataQualitySchema = z
  .object({
    model: z
      .string()
      .trim()
      ...
      .max(120)
      .optional()
      .default("legacy_campaign_insights"),
    attribution: z
      .string()
      .trim()
      .min(1)
    ...
    qualification: z
      ...
      .optional()
      .default("unavailable"),
    reportedResultsRule: z
      .string()
      .trim()
      .min(1)
      .max(160)
      .optional()
      .default("meta_leads_plus_messaging_conversations_non_unique"),
    reportedResultsMayOverlap: z.boolean().optional().default(true),
...
const marketingFilterOptionsSchema = z
  .object({
    accounts: z
      .array(
        z
...
const EMPTY_FILTER_OPTIONS = marketingFilterOptionsSchema.parse({});

export const marketingCampaignInsightsSchema = z
  .object({
    filterOptions: marketingFilterOptionsSchema
      .optional()
      .default(EMPTY_FILTER_OPTIONS),
    ...
    media: z
      .array(marketingMediaAssetSchema)
      .max(10_000)
      .optional()
      .default([]),
    ...
    dataQuality: marketingDataQualitySchema
      .optional()
      .default(EMPTY_DATA_QUALITY),
...
export type MarketingCampaignInsights = z.infer<
  typeof marketingCampaignInsightsSchema
>;
