...
const propertyManagedTermsSchema = z
  .object({
...
// React Query cache.
export const propertyWorkspacePropertySchema = z
  .object({
    id: uuidSchema,
    ...
    can_edit: z.boolean(),
    managed_terms: propertyManagedTermsSchema,
    ...
    origin_media: nullableStringSchema.optional(),
    ...
    faixa_valor_imovel: nullableStringSchema.optional(),
    renda_familiar: nullableNumberSchema.optional(),
    is_demo: nullableBooleanSchema.optional(),
  })
  .strip();
...
const propertyOwnerContactKeys = [
  ...
  keyof z.infer<typeof propertyWorkspacePropertySchema>
>;
...
export const propertyPricePeriodSchema = z.enum([
  "total",
  "daily",
  "weekly",
  "monthly",
...
export const propertyWorkspaceOfferSchema = z
  .object({
    id: uuidSchema,
    organization_id: uuidSchema,
...
export const propertyWorkspaceOwnerSchema = z
  .object({
    id: uuidSchema,
    name: z.string().min(1),
...
export const propertyWorkspaceOwnershipSchema = z
  .object({
    id: uuidSchema,
    organization_id: uuidSchema,
    property_id: uuidSchema,
...
export const propertyWorkspaceAssetSchema = z
  .object({
    id: uuidSchema,
    organization_id: uuidSchema,
    property_id: uuidSchema,
...
const nullableOwnerField = (max: number) =>
  z.string().trim().max(max).nullable().optional();
const nullableAssetField = (max: number) =>
  z.string().trim().max(max).nullable().optional();

const propertyOwnerDetailsShape = {
...
const validateOwnerNotificationEmail = (
  owner: { notify_email?: boolean; email?: string | null },
...
export const propertyOwnerDetailsInputSchema = z
  .object(propertyOwnerDetailsShape)
  .strict()
  .superRefine(validateOwnerNotificationEmail);

export const propertyOwnerUpdateInputSchema = z
  .object({
    ...propertyOwnerDetailsShape,
...
export const propertyOwnershipCreateInputSchema = z
  .object({
...
export const propertyOwnershipUpdateInputSchema = z
  .object({
    ...propertyOwnershipRelationshipShape,
...
export const propertyOwnershipEndInputSchema = z
  .object({
...
export const propertyAssetCreateInputSchema = z
  .object({
    asset_type: propertyWorkspaceAssetSchema.shape.asset_type,
    visibility:
      propertyWorkspaceAssetSchema.shape.visibility.default("internal"),
  ...
  .superRefine((value, context) => {
    const locatorCount =
      Number(Boolean(value.storage_path)) + Number(Boolean(value.external_url));
    if (locatorCount !== 1) {
      context.addIssue({
        code: z.ZodIssueCode.custom,
        path: ["external_url"],
    ...
    if (
      value.asset_type !== "document" &&
      (value.document_category || value.expires_at)
    ) {
      context.addIssue({
        code: z.ZodIssueCode.custom,
...
export const propertyAssetUpdateInputSchema = z
  .object({
    asset_type: propertyWorkspaceAssetSchema.shape.asset_type,
...
export const propertyAssetDeleteInputSchema = z
  .object({
    expected_updated_at: workspaceTimestampSchema,
  })
  .strict();

export const propertyAssetOrderInputSchema = z
  .object({
    items: z
      .array(
        z
  ...
  .superRefine((value, context) => {
    ...
    if (
      new Set(value.items.map((item) => item.sort_order)).size !==
      value.items.length
    ) {
      context.addIssue({
        code: z.ZodIssueCode.custom,
        path: ["items"],
        message: "A ordem nao pode repetir posicoes",
      });
    }
  });

export const propertyAssetPrimaryInputSchema = z
  .object({
    expected_updated_at: workspaceTimestampSchema,
  })
  .strict();

export const propertyAssetUploadIntentInputSchema = z
  .object({
...
export const propertyAssetUploadDiscardInputSchema = z
  .object({
    storage_path: z.string().trim().min(1).max(2_000),
  })
  .strict();

export const propertyAssetUploadIntentSchema = z
  .object({
...
export const propertyWorkspaceKeySchema = z
  .object({
    id: uuidSchema,
    organization_id: uuidSchema,
    property_id: uuidSchema,
...
export const propertyWorkspaceKeyMovementSchema = z
  .object({
    id: uuidSchema,
    organization_id: uuidSchema,
...
const propertyPublicationCheckSchema = z
  .object({
    code: z.string().min(1),
...
const propertyWorkspaceSummarySchema = z
  .object({
...
export const propertyWorkspaceDevelopmentLinkSchema = z
  .object({
    development: z
      .object({
        id: uuidSchema,
        ...
        commercial_status: z.string().min(1),
      })
      .strict(),
    phase: z
      .object({
...
const propertyWorkspaceResponseEnvelopeSchema = z
  .object({
    data: z
      .object({
        property: propertyWorkspacePropertySchema,
        development_link: propertyWorkspaceDevelopmentLinkSchema
          .nullable()
          .default(null),
    ...
    meta: z
      .object({
        ...
        has_asset_photos: z.boolean().default(false),
        development_link_available: z.boolean().default(false),
        normalized_resources_available: z.boolean().default(true),
        unavailable_resources: z
          .array(
            z.enum(["offers", "ownerships", "assets", "keys", "key_history"]),
          )
          .default([]),
      })
      .strict(),
...
export const apiPropertyWorkspaceResponseSchema =
  propertyWorkspaceResponseEnvelopeSchema.transform((response) => {
      ...
      data: {
        ...
        assets: response.meta.can_view_confidential
          ...
          : response.data.assets.filter(
              (asset) => asset.visibility !== "confidential",
            ),
      },
    };
  });

export const propertyOfferUpsertInputSchema = z
  .object({
...
export const propertyKeyCreateInputSchema = z
  .object({
...
export const propertyKeyMovementInputSchema = z
  .object({
...
export const apiPropertyWorkspaceOfferResponseSchema = z
  .object({
    data: propertyWorkspaceOfferSchema,
  })
  .strict();

export const apiPropertyWorkspaceKeyResponseSchema = z
  .object({
    data: propertyWorkspaceKeySchema,
  })
  .strict();

export const apiPropertyWorkspaceKeyMovementResponseSchema = z
  .object({
    data: z
      .object({
...
export const apiPropertyWorkspaceOwnershipResponseSchema = z
  .object({
    data: propertyWorkspaceOwnershipSchema,
  })
  .strict();

export const apiPropertyWorkspaceAssetResponseSchema = z
  .object({
    data: propertyWorkspaceAssetSchema,
  })
  .strict();

export const apiPropertyWorkspaceAssetListResponseSchema = z
  .object({
    data: z.array(propertyWorkspaceAssetSchema),
  })
  .strict();

export const apiPropertyWorkspaceAssetDeleteResponseSchema = z
  .object({
    data: z.object({ id: uuidSchema }).strict(),
  })
  .strict();

export const apiPropertyAssetUploadIntentResponseSchema = z
  .object({
    data: propertyAssetUploadIntentSchema,
  })
  .strict();

export const apiPropertyAssetUploadDiscardResponseSchema = z
  .object({
    data: z.object({ storage_path: z.string().min(1) }).strict(),
  })
  .strict();
...
export type PropertyWorkspaceOffer = z.infer<
  typeof propertyWorkspaceOfferSchema
>;
export type PropertyWorkspaceOwnership = z.infer<
  typeof propertyWorkspaceOwnershipSchema
>;
export type PropertyWorkspaceAsset = z.infer<
  typeof propertyWorkspaceAssetSchema
>;
export type PropertyWorkspaceKey = z.infer<typeof propertyWorkspaceKeySchema>;
export type PropertyKeyMovementType = z.infer<
  typeof propertyKeyMovementTypeSchema
>;
export type PropertyWorkspaceKeyMovement = z.infer<
  typeof propertyWorkspaceKeyMovementSchema
>;
export type PropertyWorkspaceOwner = z.infer<
  typeof propertyWorkspaceOwnerSchema
>;
export type PropertyWorkspacePayload = z.infer<
  typeof apiPropertyWorkspaceResponseSchema
>["data"];
export type PropertyWorkspaceMeta = z.infer<
  typeof apiPropertyWorkspaceResponseSchema
>["meta"];
export type PropertyOfferUpsertInput = z.input<
  typeof propertyOfferUpsertInputSchema
>;
export type PropertyKeyCreateInput = z.input<
  typeof propertyKeyCreateInputSchema
>;
export type PropertyKeyMovementInput = z.input<
  typeof propertyKeyMovementInputSchema
>;
export type PropertyOwnerDetailsInput = z.input<
  typeof propertyOwnerDetailsInputSchema
>;
export type PropertyOwnerUpdateInput = z.input<
  typeof propertyOwnerUpdateInputSchema
>;
export type PropertyOwnershipCreateInput = z.input<
  typeof propertyOwnershipCreateInputSchema
>;
export type PropertyOwnershipUpdateInput = z.input<
  typeof propertyOwnershipUpdateInputSchema
>;
export type PropertyOwnershipEndInput = z.input<
  typeof propertyOwnershipEndInputSchema
>;
export type PropertyAssetCreateInput = z.input<
  typeof propertyAssetCreateInputSchema
>;
export type PropertyAssetUpdateInput = z.input<
  typeof propertyAssetUpdateInputSchema
>;
export type PropertyAssetDeleteInput = z.input<
  typeof propertyAssetDeleteInputSchema
>;
export type PropertyAssetOrderInput = z.input<
  typeof propertyAssetOrderInputSchema
>;
export type PropertyAssetPrimaryInput = z.input<
  typeof propertyAssetPrimaryInputSchema
>;
export type PropertyAssetUploadIntentInput = z.input<
  typeof propertyAssetUploadIntentInputSchema
>;
export type PropertyAssetUploadIntent = z.infer<
  typeof propertyAssetUploadIntentSchema
>;
export type PropertyAssetUploadDiscardInput = z.input<
  typeof propertyAssetUploadDiscardInputSchema
>;
