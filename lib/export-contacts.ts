...
const contactExportColumns: ExportColumn[] = [
  ...
  { header: 'Ultimo contato', key: 'ultimo_contato', width: 18 },
  { header: 'Proximo follow-up', key: 'proximo_follow_up', width: 18 },
  ...
  { header: 'Faixa de valor do imovel', key: 'faixa_valor_imovel', width: 24 },
  ...
  { header: 'Codigo do imovel', key: 'codigo_imovel', width: 18 },
  { header: 'ID do imovel', key: 'imovel_id', width: 36 },
  { header: 'ID do imovel de interesse', key: 'imovel_interesse_id', width: 36 },
  ...
  { header: 'ID do formulario', key: 'formulario_id', width: 24 },
  ...
  { header: 'Usuario primeiro toque', key: 'primeiro_toque_usuario_id', width: 36 },
  ...
  { header: 'Usuario primeira resposta', key: 'primeira_resposta_usuario_id', width: 36 },
