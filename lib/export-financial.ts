...
export function prepareFinancialEntriesExport(
  entries: FinancialEntryExportRow[],
): ExportData[] {
...
export function prepareCommissionsExport(
  commissions: CommissionExportRow[],
): ExportData[] {
...
export function prepareContractsExport(
  ...
  return contracts.map((c) => ({
    ...
    Tipo:
      c.type === "sale" ? "Venda" : c.type === "rent" ? "Locação" : "Serviço",
    Imóvel: c.property?.code || "-",
