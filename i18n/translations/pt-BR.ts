export const ptBR = {
  ...
  nav: {
    ...
    propertiesDevelopments: "Lançamentos",
    ...
    managementTeams: "Equipes",
    managementDistribution: "Distribuição",
    managementPipelines: "Pipelines",
    managementTags: "Tags",
    ...
    automationList: "Automações",
    automationTemplates: "Modelos",
    automationHistory: "Histórico",
    mySite: "Site",
    site: "Site",
    siteGeneral: "Configuração",
    siteAppearance: "Aparência",
    siteMenu: "Menu e busca",
    siteSeo: "SEO",
    siteAnalytics: "Analytics",
    meta: "Meta",
    gamification: "Arena Imobiliária",
    arena: "Arena Imobiliária",
    arenaOverview: "Visão geral",
    arenaRanking: "Ranking",
    arenaSettings: "Configuração",
    arenaMissions: "Missões",
    arenaActivities: "Atividades",
    history: "Histórico",
    more: "Mais",
    summary: "Geral",
    campaigns: "Campanhas",
  ...
  settings: {
    ...
    profile: {
      ...
      state: "UF",
      changePhotoNote:
        "Para alterar nome ou email, entre em contato com o administrador.",
    ...
    integrations: {
      meta: {
        ...
        description:
          "Conecte sua conta Meta para receber leads automaticamente",
        connected: "Conectado",
        ...
        disconnectConfirm:
          "Você deixará de receber leads desta página. Esta ação pode ser desfeita reconectando a página.",
        ...
        pipelineNote:
          "Usado quando nenhum formulário específico estiver configurado",
