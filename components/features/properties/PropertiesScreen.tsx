    ...
    <AppLayout title="Imóveis">
      <div className="space-y-4 sm:space-y-6 animate-in">
          ...
          <div>
            <p className="text-sm text-muted-foreground">
              {activeFilterCount > 0
                ...
                : 'Pesquise e refine a carteira de imóveis pelo painel lateral.'}
            </p>
          </div>
            ...
            {!isMobile && (
              <div className="flex items-center gap-2">
                ...
                <Select value={gridCols} onValueChange={setGridCols}>
                  <SelectTrigger className="w-16 border-white/[0.055] bg-white/[0.035]">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
        ...
        <div className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_300px]">
            ...
            {properties.length === 0 && (
              <Card className="app-card">
                <CardContent className="py-12 text-center">
                  <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-white/[0.045]">
                    <Building2 className="h-6 w-6 text-primary" />
                  </div>
          ...
          <aside className="app-card order-first h-fit p-4 xl:sticky xl:top-24 xl:order-last">
