...
import type { DefaultLegendContentProps, TooltipContentProps, TooltipPayload } from "recharts";
...
>(({ id, className, children, config, ...props }, ref) => {
  ...
  const measuredChart = React.isValidElement(children)
    ? React.cloneElement(children as React.ReactElement<{ width?: number; height?: number }>, chartSize)
    : children;
    ...
    <ChartContext.Provider value={{ config }}>
      ...
      >
        ...
        {chartIsReady ? (
          ...
          <div className="h-full min-h-px w-full min-w-px" />
        )}
      </div>
...
const ChartTooltipContent = React.forwardRef<
  HTMLDivElement,
  Omit<TooltipContentProps, "active" | "payload"> &
    React.ComponentProps<"div"> & {
      active?: boolean;
