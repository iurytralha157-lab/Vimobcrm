-- leads.source_session_id accepts provider-specific identifiers as text, while
-- WhatsApp sessions use UUIDs. Keep the RPC contract typed and cast at storage.
  ...
  if found then
    update public.leads l
       set whatsapp_avatar_url = case
           ...
           source_session_id = coalesce(l.source_session_id, p_source_session_id::text),
