-- Forward-only reconciliation for databases whose 20260731082305 effects were
-- only partially applied. Keep this body aligned with the canonical migration
-- so columns, routines, lifecycle behavior, and RLS guards converge together.
