...
begin
  ...
  if v_has_rows then
    raise exception using
      errcode = '55000',
      message = 'get_telephony_ranking retirement requires manual review because telephony_calls contains data';
  end if;
end
$contract$;

drop function if exists public.get_telephony_ranking(
