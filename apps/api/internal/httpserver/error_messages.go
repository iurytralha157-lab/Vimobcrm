...
var exactUserErrorMessages = map[string]string{
	...
	"billing_access_required":              "Regularize a assinatura para continuar usando os recursos da plataforma.",
	...
	"marketing_capacity_unavailable":       "O serviço de dados atingiu o limite temporário de conexões. Aguarde alguns instantes e tente novamente.",
	"marketing_query_timeout":              "A consulta de Marketing demorou mais que o esperado. Aguarde alguns instantes e tente novamente.",
	"marketing_schema_unavailable":         "A estrutura de dados de Marketing ainda não está disponível neste ambiente.",
	"marketing_sync_in_progress":           "Já existe uma sincronização de Marketing em andamento para esta organização.",
	...
	"property_has_linked_leads":            "N\u00e3o \u00e9 poss\u00edvel excluir este im\u00f3vel porque h\u00e1 leads vinculados a ele. Desvincule o im\u00f3vel desses leads e tente novamente.",
	"property_location_identity_conflict":  "J\u00e1 existe uma cidade, bairro ou condom\u00ednio com os mesmos dados, possivelmente desativado. Reative o cadastro existente ou use dados diferentes.",
